  ...
  return (
    <div className="bg-black/40 rounded-lg p-6 border-4 border-yellow-400/50 w-[500px]">
      <div className="flex items-center gap-4">
        ...
        <div className="text-xl font-bold leading-tight text-white w-[240px] flex-shrink-0">
          {formatPayout(5)}
          {formatPayout(4)}
          {formatPayout(3)}
        </div>
...
export function MiddleSection({ betAmount }: MiddleSectionProps) {
  ...
  return (
     ...
     */
    <div
      className="flex-[1.5] flex items-center justify-center bg-black/20 border-b-2 border-primary/30 px-2 py-4 relative"
      style={{
        background:
    ...
    >
      ...
      */}
      <div className="grid grid-cols-2 gap-x-6 gap-y-4 w-full relative">
        {/* 
