 ...
 * 
 * This component displays an animated background sequence of 121 webp images.
 ...
 * 
 * Displays a looping animation of 121 background images.
 * During free spins: /images/backround/Background2/Background2/Background2_1.webp to Background2_121.webp
 * Normal mode: /images/backround/Background1/Background1/Background1_1.webp to Background1_121.webp
 * 
 * @param isFreeSpinsMode - Whether currently in free spins mode (uses Background2 if true)
 */
export function BackgroundAnimation({ isFreeSpinsMode = false }: { isFreeSpinsMode?: boolean }) {
  ...
  // Preload all 121 images - reload when free spins mode changes
  useEffect(() => {
    ...
    const loadImages = async () => {
      ...
      const backgroundFolder = isFreeSpinsMode ? 'Background2' : 'Background1';
      ...
      for (let i = 1; i <= totalFrames; i++) {
        ...
        const promise = new Promise<HTMLImageElement>((resolve, reject) => {
          ...
          img.onerror = reject;
          img.src = `/images/backround/${backgroundFolder}/${backgroundFolder}/${backgroundFolder}_${i}.webp`;
        });
